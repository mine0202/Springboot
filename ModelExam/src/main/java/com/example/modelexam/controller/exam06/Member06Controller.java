...
public class Member06Controller {
    ...
    @Autowired
    Member06Service memberService; // memberService 객체 받아오기
...
//    /member 로 들어오면 해당 서비스를 실행해야함 그래서 memberService 객체를 받아와서 함수를 사용
    ...
    public String getMemberAll(Model model){
        ...
        return "exam06/member/member_all.html";  // 이동할 홈페이지
    }

    @GetMapping("/member/addition")
    public String addMember(){
        return "exam06/member/add_member.html";
    }
